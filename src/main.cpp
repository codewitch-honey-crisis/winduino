...
void setup(void) {
    ...
    hardware_set_pin(hw_screen,TFT_CS, SPI_SCREEN_PIN_CS);
    hardware_set_pin(hw_screen,TFT_DC,SPI_SCREEN_PIN_DC);
    hardware_set_pin(hw_screen,TFT_RST,SPI_SCREEN_PIN_RST);
#endif
  tft.init();
